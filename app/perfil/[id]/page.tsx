              ...
              <div className="text-center">
                ...
                <div className="mt-4">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {freelancer.verified && <CheckCircle2 className="h-5 w-5 text-accent" title="Perfil verificado" />}
                  </div>
                ...
                <div className="mt-4 flex items-center justify-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">({freelancer.reviews} reseñas)</span>
                </div>
              ...
              <TabsContent value="resenas" className="mt-6 space-y-4">
                <div className="mb-6 flex items-center gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-muted-foreground">{freelancer.reviews} reseñas</div>
                  </div>
                </div>
